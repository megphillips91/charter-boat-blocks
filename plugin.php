...
function charter_boat_blocks_includes_jquery_scripts(){
   wp_enqueue_script( 'charter_boat_block_jquery_scripts',plugin_dir_url( __FILE__ ).'charter-boat-blocks-jquery.js', array( 'jquery' ),'',true );
   wp_localize_script( 'charter_boat_block_jquery_scripts', 'charter_boat_vars',
	   array(
...
add_action( 'wp_enqueue_scripts', 'charter_boat_blocks_includes_jquery_scripts' );
